...
<?php
$sql    = "SELECT id_proyek FROM kriteriajumlahproyek";
        ...
        <div class="col-xl-12  col-lg-8">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h5 class="m-0 font-weight-bold text-primary"> <b> Tambah Kriteria Jumlah Proyek</b></h5>
            </div>
            <div class="card-body">
              <form class="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <input class="form-control" type="text" name="id_proyek" value="<?= $kodeoto ?>" readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-12 col-sm-12 col-xs-12"> Jumlah Proyek </label>
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <input class="form-control" type="text" name="jumlah_proyek" required>
                  </div>
                </div>
                <div class="form-group">
...
if (isset($_POST['simpan'])) {
  ...
  $query = "INSERT INTO kriteriajumlahproyek (id_proyek, jumlah_proyek, nilai) VALUES ('$id_proyek','$jumlah_proyek','$nilai')";
